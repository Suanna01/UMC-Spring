...
public class ResponseMessage {
    ...
    public static final String UPDATE_USER_FAIL = "회원 정보 수정 실패";
    ...
    public static final String CREATE_BOARD_FAIL = "글 등록 실패";
    public static final String UPDATE_BOARD = "글 수정 성공";
    public static final String READ_BOARD = "전체 글 조회 성공";
    public static final String DELETE_BOARD = "글 삭제 성공";
}
